...
func (c *ResourcePoolCollector) Collect(s *scrapeContext) {
	...
	if err := v.Retrieve(s.ctx, []string{"ResourcePool"},
		[]string{"name", "config", "summary", "vm"}, &rps); err != nil {
